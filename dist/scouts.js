...
(function (module) {
	...
	(() => {
		...
		if (!commonjsGlobal.TextEncoder) {
			commonjsGlobal.TextEncoder = require$$2.TextEncoder;
		}

		if (!commonjsGlobal.TextDecoder) {
			commonjsGlobal.TextDecoder = require$$2.TextDecoder;
		}
		...
		if (
			commonjsGlobal.require &&
			commonjsGlobal.require.main === module &&
			commonjsGlobal.process &&
			commonjsGlobal.process.versions &&
			!commonjsGlobal.process.versions.electron
		) {
...
const resetGame = () => unwrapCall(window.__Scouts.resetGame);
const boardPieces = () => unwrapCall(window.__Scouts.boardPieces);
const pastTurns = () => unwrapCall(window.__Scouts.pastTurns);
const currentTurn = () => unwrapCall(window.__Scouts.currentTurn);
const makeMove = (player, move) => unwrapCall(window.__Scouts.makeMove, player, move);
const possibleMoves = (player) => unwrapCall(window.__Scouts.possibleMoves, player);
function waitForScouts() {
...
export { boardPieces, currentTurn, load, makeMove, pastTurns, possibleMoves, resetGame };
